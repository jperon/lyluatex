...
\lysetoption{verbatim}{true}
\lysetoption{intertext}{The “intertext” option can be used to print some text between the code and the score}
...
\lysetoption{verbatim}{false}
\lysetoption{intertext}{}
