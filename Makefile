...
manual:
	(cd examples/ && lualatex --shell-escape insert-systems && lualatex --shell-escape insert-inline && lualatex --shell-escape print-only && lualatex --shell-escape dynamic-indent && lualatex --shell-escape fonts)
