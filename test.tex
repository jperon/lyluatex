...
\usepackage[program=lilypond, tmpdir=tmp_ly, optimize-pdf=true]{lyluatex}
\usepackage{multicol}
...
\lilypondfile[line-width=250\pt, insert=fullpage, label=test]{ly/AveMariaDeLourdes/AveMariaDeLourdes.ly}
