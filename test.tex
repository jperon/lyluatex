...
\usepackage[program=lilypond, tmpdir=tmp_ly, pass-fonts, verbatim-highlight, debug]{lyluatex}
\usepackage{multicol}
...
% It's possible to wrup `ly` within another environment, using \ly[] and \endly.
